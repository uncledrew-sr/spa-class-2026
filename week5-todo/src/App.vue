  ...
  <button @click="addTodo">추가</button>
    ...
    <ul class="todo-list">
      <li v-for="todo in todos" :key="todo.id" class="todo-item">
        ...
        <button class="delete-btn" style="color: #ff4c4c;" @click="removeTodo(todo.id)">삭제</button>
      </li>
    </ul>
  </div>
</template>
...
.input-area input { flex: 1; padding: 12px; border: 1px solid #ddd; border-radius: 6px; font-size: 16px; outline: none; }
.input-area input:focus { border-color: #42b883; }
.input-area button { padding: 12px 20px; background: #42b883; color: white; border: none; border-radius: 6px; cursor: pointer; font-weight: bold; font-size: 15px; }
