...
<template>
  <div class="container">
    ...
    <div class="movie-grid">
        <div v-for="movie in movies" :key="movie.id" class="card" v-show="(currentTab === '전체' || movie.genre === currentTab) && movie.title.includes(searchKeyword)">
    ...
    <div v-if="isModalOpen" class="modal-bg" @click="isModalOpen = false">
      <div class="modal-content" @click.stop>
        ...
        <button class="delete-btn" @click="deleteMovie(selectedMovie.id)">🗑️ 삭제하기</button>
      </div>
    </div>
